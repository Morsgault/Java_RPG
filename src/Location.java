...
public class Location
{
    ...
    public Location(int worldSize, String charName,
                    int locationX, int locationY) throws IOException
    {
        x = locationX;
        y = locationY;
        alive = true;
    ...
    /*
     * This method gives the player the map if they happen to find it in the
     * world
     */
    public void findMap()
    {
    ...
    /*
     * This method generates the world or if the player has a save file reloads
     * the world.
     */
    private void genWorld() throws IOException
    {
        if (Exists(playerName))
        {
            BufferedReader load = new BufferedReader(
                new FileReader(playerName + "Map.txt")
            );
            ...
            for (int a = 0; a < mapSize; ++a)
                for (int b = 0; b < mapSize; b++)
                    world[a][b] =
                        Integer.parseInt(loadMap[a].substring(b, b + 1));
        }
        else
        {
