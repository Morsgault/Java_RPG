...
public class TextAdventure
{
                                                  ...
                                                  IOException
    {
        ...
        System.out.println(
"You find yourself on a deserted island. The last thing you remember is\n" +
"going to bed on in your cabin on your ship on route to Africa."
        );

        while (location.isAlive())
        {
            System.out.println(
                description.getDescription(location.getX(), location.getY())
            );
